...
const endOfUseMemoMatch = content.indexOf('return (', tHelperMatch.index);
...
const afterReturn = content.substring(startReturn);
// find end of component
const componentEnd = content.lastIndexOf('export default');
