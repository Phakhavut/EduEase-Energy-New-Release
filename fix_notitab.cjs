...
// I will just replace the whole file from the beginning. Actually, let me just find the broken part.
// But it's easier to recreate the return statement for NotiTab because I know what it should look like.

// Wait, I can extract the `return (` to the end and replace it.
...
notiTab = notiTab.replace(/return \([\s\S]*\}\);/, newReturn);
